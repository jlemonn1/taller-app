export default function CampoFecha({ label, value, onChange, icono: Icono }) {
    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full ${Icono ? 'pl-10' : 'pl-3'} pr-3 py-3 bg-gray-50 border rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-taller-green/30 focus:border-taller-green transition-all appearance-none ${
